...
class TestValidacionConvenios:
    ...
    def test_convenio_colectivo_sin_asamblea_rechazado(
        self, client, admin_session, seed_tramo_nucleo, seed_afectacion_colectiva
    ):
    ...
    def test_tipo_convenio_incompatible_con_afectacion_individual(
        self, client, admin_session, seed_tramo_nucleo, seed_afectacion_individual,
    ):
...
class TestValidacionAfectaciones:
    ...
    def test_individual_sin_parcela_rechazada(
        self, client, admin_session, seed_nucleo, seed_tramo_nucleo,
    ):
    ...
    def test_tramo_nucleo_inexistente(
        self, client, admin_session, seed_nucleo,
    ):
...
class TestBajaLogica:
    ...
    def test_baja_sin_motivo_rechazada(self, client, admin_session, seed_tramo):
    ...
    def test_baja_con_motivo_vacio_rechazada(
        self, client, admin_session, cleanup, seed_nucleo
    ):
        ...
        res_create = client.post("/api/padrones", json=payload, headers=admin_session)
