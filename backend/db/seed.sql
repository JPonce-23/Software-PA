...
BEGIN
    ...
    INSERT INTO parcela (id_nucleo, tipo_parcela, no_parcela_ppt, certificado_parcelario, folio_derechos, constancia_vigencia_fecha, geometria_poligono, fuente_geometria, fecha_fuente_geometria, creado_en, creado_por, observaciones)
    ...
    INSERT INTO parcela (id_nucleo, tipo_parcela, no_parcela_ppt, certificado_parcelario, folio_derechos, constancia_vigencia_fecha, creado_en, creado_por, observaciones) VALUES (v_n2, 'individual', 'P-170', '79953', '22FD00074310', DATE '2025-08-25', v_seed_time, v_admin, 'Sin geometría por diseño') RETURNING id_parcela INTO v_parcel170;
    INSERT INTO parcela (id_nucleo, tipo_parcela, no_parcela_ppt, certificado_parcelario, folio_derechos, constancia_vigencia_fecha, creado_en, creado_por, observaciones) VALUES (v_n2, 'individual', 'P-173', '55831', '22FD00055387', DATE '2025-08-25', v_seed_time, v_admin, 'Sin geometría por diseño') RETURNING id_parcela INTO v_parcel173;
    INSERT INTO parcela (id_nucleo, tipo_parcela, no_parcela_ppt, certificado_parcelario, folio_derechos, constancia_vigencia_fecha, creado_en, creado_por, observaciones) VALUES (v_n2, 'individual', 'P-169', '55836', '22FD00055392', DATE '2025-08-25', v_seed_time, v_admin, 'Sin geometría por diseño') RETURNING id_parcela INTO v_parcel169;
