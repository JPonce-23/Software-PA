...
Instalación limpia: `001_baseline_v1.sql` → `002_cierre_fuentes_excel.sql` → `003_reporting_fuentes_excel.sql` → `004_seguimiento_funcional_excel.sql` → `005_reporting_cierre_excel.sql`.
